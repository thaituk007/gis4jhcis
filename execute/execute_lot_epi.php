...
<body  onload="cursor();">
<?php
$txt = "<br><form id='frm_old' name='frm_old' method='get' action='update_lot_dt.php'>";  
$txt .= "<table><tr><td>บันทึก Lot No วัคซีน dT <input type='text' name='lot' id='lot' />  วันหมดอายุวัคซีน dT
      <input name='date_end' type='text' size='8' id='datepicker-th2' onkeypress='date_fbb(this);' onchange='getData();' value='$dayend'/>
	  </td><td><input type='submit' name='Submit' value='บันทึก' /></td></tr></table></form>";
echo $txt;
?>
<?php
}
