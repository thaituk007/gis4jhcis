...
$result = mysql_query($sql);
$txt = '<p align=\'center\'><b>รายชื่อหญิงอายุต่ำกว่า 20 ปี ที่อยู่กินกับสามีได้รับการวางแผนครอบครัว</b><br>';
$txt .= "<b>ข้อมูลระหว่างวันที่ $_GET[str] ถึง $_GET[sto] หมู่ที่ $mu </b></p><br><b>$hosp</b><table width='95%' border='0' cellspacing='1' cellpadding='1' class='table table-striped table-hover table-bordered'>
  <tr>
