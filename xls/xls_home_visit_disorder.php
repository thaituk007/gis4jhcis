...
$result = mysql_query($sql);
$txt = '<p align=\'center\'><b>รายชื่อพิการที่ได้รับการเยี่ยมบ้าน</b><br>';
$txt .= "<b>ข้อมูลระหว่างวันที่ $strx ถึง $stox  $mu </b></p><br><b>$hosp</b><table width='99%' border='0' cellspacing='1' cellpadding='1' class='table table-striped table-hover table-bordered'>
  <tr>
	...
	<th width='10%' scope='col'><div align='center'>พิการ</div></th>
...
$txt .="  <tr $cr>
	...
	<td><div align='center'>$row[incom]</div></td>
