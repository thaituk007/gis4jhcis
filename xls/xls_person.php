...
if($live_type == '2'){$live_type2 = "and p.typelive in ('0','1','2')";}elseif($live_type == '1'){$live_type2 = "and p.typelive in ('0','1','3')";}else{$live_type2 = "and p.typelive in ('0','1','2','3')";}
	$sql = "SELECT p.pid, p.idcard, p.prename,CONCAT(p.fname,' ',p.lname) AS pname,h.hno,h.villcode,h.xgis,h.ygis,p.birth,
...
$txt .= "$ect1_name ที่อายุระหว่าง&nbsp;&nbsp;$age&nbsp;&nbsp;ปี  $mu</b><br></p>$live_type_name<br><b>$hosp</b><br><table class='table table-striped table-hover table-bordered' width='98%' border='0' cellspacing='1' cellpadding='1'>
  <tr>
    <th width='8%' scope='col'><div align='center'>ลำดับ</div></th>
	<th width='7%' scope='col'><div align='center'>HN</div></th>
	<th width='10%' scope='col'><div align='center'>เลขบัตรประชาชน</div></th>
    <th width='22%' scope='col'><div align='center'>ชื่อ - สกุล</div></th>
	<th width='15%' scope='col'><div align='center'>ว/ด/ป เกิด</div></th>
	<th width='8%' scope='col'><div align='center'>อายุ(ปี)</div></th>
    <th width='8%' scope='col'><div align='center'>บ้านเลขที่</div></th>
    <th width='8%' scope='col'><div align='center'>หมู่ที่</div></th>
    <th width='10%' scope='col'><div align='center'>หมายเหตุ</div></th>
  </tr>";
...
$txt .= "</table><p div align='right' class='text-danger'>คำนวนอายุถึงวันที่ $strx </p></div><br>";  
echo $txt;
