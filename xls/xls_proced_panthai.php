...
$result = mysql_query($sql);
$txt = '<p align=\'center\'><b>รายงานการให้บริการหัตถการแพทย์แผนไทย</b></p>';
$txt .= "<b><p div align='center' class='text-danger'>ข้อมูลระหว่างวันที่  $strx ถึง $stox </p></div>$mu</b></p><b>$hosp</b><br><table width='95%' border='0' cellspacing='1' cellpadding='1' class='table table-striped table-hover table-bordered'>
  <tr>
    <th width='5%' scope='col'><div align='center'>ลำดับ</div></th>
	<th width='13%' scope='col'><div align='center'>เลขบัตรประชาชน</div></th>
    <th width='16%' scope='col'><div align='center'>ชื่อ - สกุล</div></th>
	<th width='13%' scope='col'><div align='center'>ที่อยู่</div></th>
	<th width='10%' scope='col'><div align='center'>วันที่ใช้บริการ</div></th>
	<th width='22%' scope='col'><div align='center'>กิจกรรม</div></th>
    <th width='16%' scope='col'><div align='center'>ผู้ให้บริการ</div></th>
	<th width='8%' scope='col'><div align='center'>จำนวนบริการ</div></th>
    <th width='10%' scope='col'><div align='center'>วันที่บันทึกข้อมูล</div></th>
  </tr>";
...
$txt .="  <tr $cr>
    ...
    <td>$row[drugname]</td>
	<td>$row[uname]</td>
	<td><div align='center'>$row[ctime]</td>
    <td>$dupdate</td>
  </tr>";
}
$txt .= "</table><br>";  
