...
var customIcons = {
  ...
  function getData(){
			...
			var url = "../genxml/genxml_markhouse.php?villcode="+villcode;
		...
		var inshtml = "หมู่ที่ "+mu+" รหัสบ้าน"+slmooban+"<br>บ้านเลขที่ <input type='text' size='8' name='hono' id='hono'><br>"+
...
function delData(hcode){
  createXMLHttpRequest();
      var urld = "../execute/execute.php?hcode=" + hcode;	
...
function saveData(){
      ...
      var url = "../execute/execute.php?villagecode="+villagecode+"&hno="+hono+"&lat="+uplat+"&lng="+uplng; 
	  createXMLHttpRequest();
