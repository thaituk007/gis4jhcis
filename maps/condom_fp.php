		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<section class="sidebar">
                	<div id="pleft">
        		<?php
				$txt = "<p align='center'><strong>รายงานการจ่ายถุงยางอนามัย<br>ในงานวางแผนครอบครัว</strong></p>";
...
function getData(){
			...
			var url = "../genxml/genxml_condom_fp.php?str="+str;
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+"<br><img src='../img/"+simg+"'> หมู่ "+moo+ " บ้านเลขที่ " + hono+"<br>"+drugname+" จำนวน "+unitx+" ชิ้น<br>รับบริการ "+sick;
		   	html2 = pname+"<br>บ้านเลขที่ "+hono+" หมู่ " +vill + "<br>" + drugname+" จำนวน "+unitx+" ชิ้น <br>รับบริการ "+sick;
...
function getXls(){
	var str = document.getElementById('datestart').value;
	var url = "../xls/xls_condom_fp.php?str="+str;
	window.open(url,'data','top=120,left=250,width=800,height=500');
}
function getchart(){
	var str = document.getElementById('datestart').value;
	var url = "../chart/chart_condom_fp.php?str="+str;
	window.open(url,'data','top=120,left=250,width=800,height=500');
}
function getsum(){
	var str = document.getElementById('datestart').value;
	var url = "../sum/sum_condom_fp.php?str="+str;
	window.open(url,'data','top=120,left=250,width=800,height=500');
}
</script>
