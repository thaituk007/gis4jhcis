		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<section class="sidebar">
                	<div id="pleft">
        		<?php
				$txt = "<p align='center'><strong>หญิงอายุต่ำกว่า 20 ปี ที่อยู่กินกับสามี<br>ได้รับการวางแผนครอบครัว</strong></p>";
...
function getData(){
			...
			var url = "../genxml/genxml_female_mary_20.php?str="+str+"&village="+village;
		  ...
		  var fp = xmldata[i].getAttribute("fp");
		  var fpname = xmldata[i].getAttribute("fpname");
		  var status = xmldata[i].getAttribute("status");
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+" อายุ "+age+" ปี<br><img src='../img/"+simg+"'> หมู่ "+moo+ " บ้านเลขที่ " + hono+" (" + status+" / "+fpname+")";
		   	html2 = pname+" อายุ "+age+" ปี<br>บ้านเลขที่ "+hono+" หมู่ " +vill +"<br>  สถานภาพ  "+status+"  คุมกำเนิดแบบ  "+
						fpname;
			var icon;
			if(fpname == "ไม่ได้คุม"){
				hno = hno + 1;
			 	icon = customIcons['c1'];
			}else if(fpname == "ไม่ระบุ"){
				rok = rok + 1;
				icon = customIcons['c2'];	
			}else{
				hok = hok + 1;
			...
			var legent = "<img src='../img/c001.png'> = คุมกำเนิด "+hok+" <br> <img src='../img/c003.png'> = ไม่ได้คุมกำเนิด "+hno+"<br> <img src='../img/c006.png'> = ไม่ระบุ "+rok;		
...
function getXls(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;		
		var url = "../xls/xls_female_mary_20.php?str="+str+"&village="+village;
	window.open(url,'data','top=120,left=250,width=700,height=550');
}
function getchart(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;	
		var url = "../chart/chart_female_mary_20.php?str="+str+"&village="+village;
	window.open(url,'data','top=120,left=250,width=900,height=500');
}
function getsum(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;
		var url = "../sum/sum_female_mary_20.php?str="+str+"&village="+village;
