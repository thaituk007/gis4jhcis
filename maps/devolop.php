		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<section class="sidebar">
                	<div id="pleft">
        		<?php
				$txt = "<p align='center'><strong>รายงานโภชนาการ 0 - 72 เดือน</strong></p>";
				...
				$txt .= "<div class='form-group'>
             				<label>กลุ่ม</label>
                  				<div class='input-group'>
                                	...
                                	<select name='chk_old' id='chk_old' class='form-control' onchange='getData();'><option value='9'>แสดงทุกคน</option><option value='2'>ปกติ</option><option value='3'>สงสัยล่าช้า</option><option value='4'>ล่าช้า</option><option value='1'>ไม่ได้รับการประเมิน</option></select>
                            	</div><!-- /.input group -->
                		</div><!-- /.form group -->";
				$txt .= "<div class='form-group'>
...
function getData(){
			...
			var url = "../genxml/genxml_devolop.php?str="+str+"&village="+village+"&chk_old="+chk_old+"&live_type="+live_type;
		  ...
		  var growdevelop = xmldata[i].getAttribute("growdevelop");
		  var growdevelopn = xmldata[i].getAttribute("growdevelopn");
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+" อายุ "+age+" ปี<br><img src='../img/"+simg+"'>บ้านเลขที่ "+hono+" หมู่ " +vill +"<br>วันที่ตรวจ "+visitdate+"<br>"+growdevelopn;
		   	html2 = pname+" อายุ "+age+" ปี<br>หมู่ "+moo+ " บ้านเลขที่ "+hono+"<br>วันที่ตรวจ "+visitdate+"<br>"+growdevelopn;
			var icon;
			if(growdevelop == "3"){
				hno = hno + 1;
			 	icon = customIcons['c0'];
			}else if(growdevelop == "2"){
				rok = rok + 1;
				icon = customIcons['c1'];
			}else if(growdevelop == "1"){
				hok = hok + 1;
				icon = customIcons['c2'];	
			}else{
				hnk = hnk + 1;
			...
			var legent = "<img src='../img/c006.png'> = พัฒนาการปกติ "+hok+" คน<br><img src='../img/c003.png'> = พัฒนาการสงสัยล่าช้า "+rok+" คน<br><img src='../img/c001.png'> = พัฒนาการล่าช้า "+hno+" คน<br><img src='../img/c002.png'> = ไม่ได้ตรวจ "+hnk+" คน";		
...
function getXls(){
		...
		var str = document.getElementById('datestart').value;
		var live_type = document.getElementById('live_type').value;
		var url = "../xls/xls_devolop.php?str="+str+"&village="+village+"&chk_old="+chk_old+"&live_type="+live_type;
...
function getchart(){
		...
		var str = document.getElementById('datestart').value;
		var live_type = document.getElementById('live_type').value;
		var url = "../chart/chart_devolop.php?str="+str+"&village="+village+"&live_type="+live_type;
...
function getsum(){
		...
		var str = document.getElementById('datestart').value;
		var live_type = document.getElementById('live_type').value;
		var url = "../sum/sum_devolop.php?str="+str+"&village="+village+"&live_type="+live_type;
