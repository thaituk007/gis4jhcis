				...
				$txt .= "<div class='form-group'>
             				<label>กลุ่ม</label>
                  				<div class='input-group'>
                                	...
                                	<select name='chk_old' id='chk_old' class='form-control' onchange='getData();'><option value='0'>แสดงทุกคน</option><option value='1'>ได้รับการตรวจ</option><option value='2'>สูงระดับดี/สมส่วน</option><option value='3'>ต้องเฝ้าระวัง</option><option value='4'>ยังไม่ได้ตรวจ</option></select>
                            	</div><!-- /.input group -->
                		</div><!-- /.form group -->";
				$txt .= "<div class='form-group'>
...
function getData(){
			...
			var url = "../genxml/genxml_nutri.php?str="+str+"&village="+village+"&chk_old="+chk_old+"&live_type="+live_type;
		  ...
		  var bwokm = xmldata[i].getAttribute("bwokm");
		  var bwok = xmldata[i].getAttribute("bwok");
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+" อายุ "+age+" เดือน<br><img src='../img/"+simg+"'>บ้านเลขที่ "+hono+" หมู่ " +vill +"<br>  "+bwokm+"<br> "+visitdate;
		   	html2 = pname+" อายุ "+age+" เดือน<br>บ้านเลขที่ "+hono+" หมู่ " +vill +"<br>  "+bwokm+"<br> "+visitdate;
			var icon;
			if(bwok == "3"){
				rok = rok + 1;
			 	icon = customIcons['c0'];	
			...
			var legent = "<img src='../img/c001.png'> = สูงระดับดี/สมส่วน"+rok+" คน <br><img src='../img/c003.png'> = ต้องเฝ้าระวัง"+hno+" คน <br><img src='../img/c006.png'> = ยังไม่ได้ชั่งน้ำหนัก"+hnk+" คน";		
...
function getXls(){
		...
		var chk_old = document.getElementById('chk_old').value;
		var str = document.getElementById('datestart').value;		
		var url = "../xls/xls_nutri.php?str="+str+"&village="+village+"&chk_old="+chk_old+"&live_type="+live_type;
...
function getchart(){
		...
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;			
		var url = "../chart/chart_nutri.php?str="+str+"&village="+village+"&live_type="+live_type;
...
function getsum(){
		...
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;		
		var url = "../sum/sum_nutri.php?str="+str+"&village="+village+"&live_type="+live_type;
