		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<section class="sidebar">
                	<div id="pleft">
        		<?php
				$txt = "<p align='center'><strong>รายชื่อเด็กที่ไม่มารับวัคซีน<br>ตาม ว/ด/ป ที่ระบุ</strong></p>";
...
function getData(){
			...
			var url = "../genxml/genxml_epi_appoint_miss.php?str="+str;
		  ...
		  var drugcode = xmldata[i].getAttribute("drugcode");
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+"<br><img src='../img/"+simg+"'> หมู่ "+moo+ " บ้านเลขที่ " + hono+"<br> ขาดนัดวัคซีน "+drugname;
		   	html2 = pname+"<br>บ้านเลขที่ "+hono+" หมู่ " +vill + "<br>เกิดวันที่"+birth+" อายุ "+age+" เดือน"+"<br> ขาดนัดวัคซีน "+drugcode+"  "+drugname;
