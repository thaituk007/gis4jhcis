...
<form role="form">
        		<?php
				$txt = "<p align='center'><strong>บันทึก/แก้ไข ตำแหน่งโรงเรียน</strong></p><br><div class='text text-danger'> กรุณาเลือกหมู่บ้านก่อนบันทึก</div>";
...
var customIcons = {
  ...
  function getData(){
			...
			var url = "../genxml/genxml_markschool.php?villcode="+villcode;
		  ...
		  var schoolno = xmldata[i].getAttribute("schoolno");
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = "<img src='../img/"+simg+"'> ลำดับที่ " + schoolno+"<br>"+hname;
		   	html2 = "ลำดับที่ "+schoolno+" หมู่ " +vill + "<br>" + hname+
		...
		var inshtml = "หมู่ที่ "+mu+" รหัสบ้าน"+slmooban+"<br>ลำดับที่ <input type='text' size='8' name='schoolno' id='schoolno'><br>"+
...
function delData(hcode){
  createXMLHttpRequest();
      var urld = "../execute/execute_school.php?hcode=" + hcode;	
...
function saveData(){
      ...
      var url = "../execute/execute_school.php?villagecode="+villagecode+"&schoolno="+schoolno+"&lat="+uplat+"&lng="+uplng; 
	  createXMLHttpRequest();
