		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<section class="sidebar">
                	<div id="pleft">
        		<?php
				$txt = "<p align='center'><strong>ประชาชนที่ได้รับการเยี่ยมบ้าน</strong></p>";
...
function getData(){
			...
			var url = "../genxml/genxml_home_visit_all.php?str="+str+"&village="+village+"&chk_stool="+chk_stool;
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+" อายุ "+age+" ปี<br><img src='../img/"+simg+"'> หมู่ "+moo+ " บ้านเลขที่ " + hono+"<br> "+chk+" "+count_visit+" ครั้ง เยี่ยมล่าสุด  "+sick+"<br>โดย "+userh;
		   	html2 = pname+" อายุ "+age+" ปี<br>บ้านเลขที่ "+hono+" หมู่ " +vill +"<br>"+chk+" "+count_visit+" ครั้ง เยี่ยมล่าสุด "+sick+"<br> โดย "+userh;
			var icon;
			if(count_visit > 0){
				hno = hno + 1;
			 	icon = customIcons['c0'];	
...
function getXls(){
		...
		var str = document.getElementById('datestart').value;
		var chk_stool = document.getElementById('chk_stool').value;			
		var url = "../xls/xls_home_visit_all.php?str="+str+"&village="+village+"&chk_stool="+chk_stool;
	window.open(url,'data','top=120,left=250,width=700,height=550');
}
function getchart(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;		
		var url = "../chart/chart_home_visit_all.php?str="+str+"&village="+village;
	window.open(url,'data','top=120,left=250,width=900,height=500');
}
function getsum(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;		
		var url = "../sum/sum_home_visit_all.php?str="+str+"&village="+village;
