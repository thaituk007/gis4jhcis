...
<form role="form">
        		<?php
				$txt = "<p align='center'><strong>บันทึก/แก้ไข<br> ตำแหน่งสถานประกอบการ</strong></p><br><div class='text text-danger'> กรุณาเลือกหมู่บ้านก่อนบันทึก</div>";
...
var customIcons = {
  ...
  function getData(){
			...
			var url = "../genxml/genxml_markbusiness.php?villcode="+villcode;
...
function delData(hcode){
  createXMLHttpRequest();
      var urld = "../execute/execute_business.php?hcode=" + hcode;	
...
function saveData(){
      ...
      var url = "../execute/execute_business.php?villagecode="+villagecode+"&fsno="+fsno+"&lat="+uplat+"&lng="+uplng; 
	  createXMLHttpRequest();
