...
function getData(){
			...
			var url = "../genxml/genxml_home_visit_old.php?str="+str+"&village="+village+"&chk_stool="+chk_stool;
...
function getXls(){
		...
		var str = document.getElementById('datestart').value;
		var chk_stool = document.getElementById('chk_stool').value;			
		var url = "../xls/xls_home_visit_old.php?str="+str+"&village="+village+"&chk_stool="+chk_stool;
	window.open(url,'data','top=120,left=250,width=700,height=550');
}
function getchart(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;		
		var url = "../chart/chart_home_visit_old.php?str="+str+"&village="+village;
	window.open(url,'data','top=120,left=250,width=900,height=500');
}
function getsum(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;	
		var url = "../sum/sum_home_visit_old.php?str="+str+"&village="+village;
