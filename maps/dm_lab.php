    ...
    <body class="skin-blue" onLoad="adjustWindow()">
		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<form role="form">
        		<?php
				$txt = "<p align='center'><strong>ผู้ป่วยเบาหวานที่ได้รับการตรวจ HbA1C</strong></p>";
...
function getData(){
			...
			var url = "../genxml/genxml_dm_lab.php?str="+str+"&village="+village;
		  ...
		  var codex = xmldata[i].getAttribute("codex");
		  var chronicx = xmldata[i].getAttribute("chronicx");
		  var ch99 = xmldata[i].getAttribute("ch99");
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+" อายุ "+age+" ปี<br><img src='../img/"+simg+"'> หมู่ "+moo+ " บ้านเลขที่ " + hono+"<br>โรคประจำตัว  " +chronicx+"<br>วันที่ตรวจ HbA1C  "+ch99;
		   	html2 = pname+" อายุ "+age+" ปี<br>บ้านเลขที่ "+hono+" หมู่ " +vill+"<br>โรคประจำตัว" +chronicx+"<br>วันที่ตรวจ HbA1C "+ch99;
			var icon;
			if(chk == 1){
				hno = hno + 1;
			 	icon = customIcons['c0'];	
			...
			var legent = "<img src='../img/c001.png'> = ได้ตรวจ HbA1C "+hno+" คน<br><img src='../img/c006.png'> = ยังไม่ได้ตรวจ "+hok;		
...
function getXls(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;			
		var url = "../xls/xls_dm_lab.php?str="+str+"&village="+village;
	window.open(url,'data','top=120,left=250,width=700,height=550');
}
function getchart(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;			
		var url = "../chart/chart_dm_lab.php?str="+str+"&village="+village;
	window.open(url,'data','top=120,left=250,width=900,height=500');
}
function getsum(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;		
		var url = "../sum/sum_dm_lab.php?str="+str+"&village="+village;
