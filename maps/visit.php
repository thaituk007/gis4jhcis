    ...
    <body class="skin-blue" onLoad="adjustWindow()">
		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<form role="form">
        		<?php
				$txt = "<p align='center'><strong>รายงานการให้บบริการ</strong></p>";
				...
				$txt .= "<div class='form-group'>
             				<label>เลือกกลุ่ม:</label>
                                ...
                                <select name='chk_v' id='chk_v' class='form-control'onchange='getData();'><option value='0'>แสดงทุกบริการ</option><option value='1'>เฉพาะOPD (ไม่นับรหัส Z)</option></select>
                            	</div><!-- /.input group -->
                		</div><!-- /.form group -->";	
...
function getData(){
			...
			var chk_v = document.getElementById('chk_v').value;
			var str = document.getElementById('datestart').value;		
			var url = "../genxml/genxml_visit.php?str="+str+"&village="+village+"&chk_v="+chk_v;
		  ...
		  var gdiagcode = xmldata[i].getAttribute("gdiagcode");
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+"<br><img src='../img/"+simg+"'> หมู่ "+moo+ " บ้านเลขที่ " + hono+"<br>"+gdiagcode+" <br>รับบริการ "+sick;
		   	html2 = pname+"<br>บ้านเลขที่ "+hono+" หมู่ " +vill + "<br>" + gdiagcode+" <br>รับบริการ "+sick;
...
function getXls(){
	...
	var chk_v = document.getElementById('chk_v').value;
	var str = document.getElementById('datestart').value;
	var url = "../xls/xls_visit.php?str="+str+"&village="+village+"&chk_v="+chk_v;
...
function getchart(){
	...
	var chk_v = document.getElementById('chk_v').value;
	var str = document.getElementById('datestart').value;
	var url = "../chart/chart_visit.php?str="+str+"&village="+village+"&chk_v="+chk_v;
	window.open(url,'data','top=120,left=250,width=800,height=500');
}
function getsum(){
	var village = document.getElementById('village').value;
	var chk_v = document.getElementById('chk_v').value;
	var str = document.getElementById('datestart').value;
	var url = "../sum/sum_visit.php?str="+str+"&village="+village+"&chk_v="+chk_v;
	window.open(url,'data','top=120,left=250,width=800,height=500');
}
</script>
