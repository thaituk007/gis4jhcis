...
<form role="form">
        		<?php
				$txt = "<p align='center'><strong>บันทึก/แก้ไข ตำแหน่งศาสนสถาน</strong></p><br><div class='text text-danger'> กรุณาเลือกหมู่บ้านก่อนบันทึก</div>";
...
var customIcons = {
  ...
  function getData(){
			...
			var url = "../genxml/genxml_marktemple.php?villcode="+villcode;
		  ...
		  var hname = xmldata[i].getAttribute("hname");
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = "<img src='../img/"+simg+"'> ลำดับที่ " + templeno+"<br>"+hname;
		   	html2 = "ลำดับที่ "+templeno+" หมู่ " +vill + "<br>" + hname+
						"<br><input type='button' value='ลบจุดบ้าน' onclick='delData("+hcode+");'/>";
		...
		var inshtml = "หมู่ที่ "+mu+" รหัสบ้าน"+slmooban+"<br>ลำดับที่ <input type='text' size='8' name='templeno' id='templeno'><br>"+
...
function delData(hcode){
  createXMLHttpRequest();
      var urld = "../execute/execute_temple.php?hcode=" + hcode;	
...
function saveData(){
	  ...
	  var templeno = document.getElementById('templeno').value;
      var url = "../execute/execute_temple.php?villagecode="+villagecode+"&templeno="+templeno+"&lat="+uplat+"&lng="+uplng; 
	  createXMLHttpRequest();
