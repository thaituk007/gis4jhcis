		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<section class="sidebar">
                	<div id="pleft">
        		<?php
				$txt = "<p align='center'><strong>รายงานการตรวจเลือดเกษตรกร</strong></p>";
...
function getData(){
			...
			var url = "../genxml/genxml_farmer.php?str="+str+"&village="+village+"&chk_old="+chk_old+"&live_type="+live_type;
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			var legent = "<img src='../img/c002.png'> = ได้รับการตรวจ "+hok+" คน<br> <img src='../img/c001.png'> = ยังไม่ได้ประเมิน "+rok+" คน";		
...
function getXls(){
		...
		var chk_old = document.getElementById('chk_old').value;
		var str = document.getElementById('datestart').value;		
		var url = "../xls/xls_farmer.php?str="+str+"&village="+village+"&chk_old="+chk_old+"&live_type="+live_type;
...
function getchart(){
		...
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;			
		var url = "../chart/chart_farmer.php?str="+str+"&village="+village+"&live_type="+live_type;
...
function getsum(){
		...
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;			
		var url = "../sum/sum_farmer.php?str="+str+"&village="+village+"&live_type="+live_type;
