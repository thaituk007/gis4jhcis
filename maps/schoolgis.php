...
function getData(){
			...
			var url = "../genxml/genxml_schoolgis.php?villcode="+villcode;
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = "<img src='../img/"+simg+"'> หมู่ "+moo+ " ลำดับที่ " + schoolno + "<br>" + hhouse;
		   	html2 = "ลำดับที่ "+schoolno+" หมู่ " +vill + "<br>" + hhouse;
