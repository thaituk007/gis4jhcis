		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<section class="sidebar">
                	<div id="pleft">
        		<?php
				$txt = "<p align='center'><strong>ประชาชนอายุ 40 ปี ขึ้นไป <br>ที่ตรวจพบพยาธิใบไม้ตับ<br>ได้รับการตรวจอัลตร้าซาวด์</strong></p>";
				...
				$txt .= "<div class='form-group'>
             				<label>กลุ่ม</label>
                  				<div class='input-group'>
                                	...
                                	<select name='chk_ultra' id='chk_ultra' class='form-control' onchange='getData();'><option value='1'>แสดงทุกคน</option><option value='2'>เฉพาะที่ได้รับการตรวจ</option><option value='3'>เฉพาะผิดปกติ</option><option value='4'>เฉพาะผู้ที่ไม่ได้ตรวจ</option></select>
                            	</div><!-- /.input group -->
                		</div><!-- /.form group -->";	
...
function getData(){
			...
			var chk_ultra = document.getElementById('chk_ultra').value;
			var str = document.getElementById('datestart').value;		
			var url = "../genxml/genxml_ultra.php?str="+str+"&village="+village+"&chk_ultra="+chk_ultra;
		  ...
		  var ultrasys = xmldata[i].getAttribute("ultrasys");
		  var ultravital = xmldata[i].getAttribute("ultravital");
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+" อายุ "+age+" ปี<br><img src='../img/"+simg+"'> หมู่ "+moo+ " บ้านเลขที่ " + hono+"<br> วันที่ตรวจ"+sick+"  "+ultravital;
		   	html2 = pname+" อายุ "+age+" ปี<br>บ้านเลขที่ "+hono+" หมู่ " +vill +"<br>  วันที่ตรวจ "+sick+"  "+ultravital;
			var icon;
			if(ultravital == "ปกติ"){
				hno = hno + 1;
			 	icon = customIcons['c1'];
			...
			var legent = "<img src='../img/c001.png'> = ผิดปกติ "+hok+" คน<br> <img src='../img/c003.png'> = ปกติ "+hno+" คน<br> <img src='../img/c006.png'> = ไม่ได้ตรวจ "+rok+" คน";	
...
function getXls(){
		...
		var str = document.getElementById('datestart').value;
		var chk_ultra = document.getElementById('chk_ultra').value;	
		var url = "../xls/xls_ultra.php?str="+str+"&village="+village+"&chk_ultra="+chk_ultra;
	window.open(url,'data','top=120,left=250,width=700,height=550');
}
function getchart(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;	
		var url = "../chart/chart_ultra.php?str="+str+"&village="+village;
	window.open(url,'data','top=120,left=250,width=900,height=500');
}
function getsum(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;		
		var url = "../sum/sum_ultra.php?str="+str+"&village="+village;
