    ...
    <body class="skin-blue" onLoad="adjustWindow()">
		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<form role="form">
        		<?php
				$txt = "<p align='center'><strong>รายงานการจ่ายถุงยางอนามัยในงานป้องกันเอดส์</strong></p>";
...
function getData(){
			...
			var url = "../genxml/genxml_condom_aids.php?str="+str;
		  ...
		  var unitx = xmldata[i].getAttribute("unit");
		  var unitsellname = xmldata[i].getAttribute("unitsellname");
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+"<br><img src='../img/"+simg+"'> หมู่ "+moo+ " บ้านเลขที่ " + hono+"<br>"+drugname+" จำนวน "+unitx+" "+unitsellname+"<br>รับบริการ "+sick;
		   	html2 = pname+"<br>บ้านเลขที่ "+hono+" หมู่ " +vill + "<br>" + drugname+" จำนวน "+unitx+" "+unitsellname+"<br>รับบริการ "+sick;
...
function getXls(){
	var str = document.getElementById('datestart').value;
	var url = "../xls/xls_condom_aids.php?str="+str;
	window.open(url,'data','top=120,left=250,width=800,height=500');
}
function getchart(){
	var str = document.getElementById('datestart').value;
	var url = "../chart/chart_condom_aids.php?str="+str;
	window.open(url,'data','top=120,left=250,width=800,height=500');
}
function getsum(){
	var str = document.getElementById('datestart').value;
	var url = "../sum/sum_condom_aids.php?str="+str;
	window.open(url,'data','top=120,left=250,width=800,height=500');
}
</script>
