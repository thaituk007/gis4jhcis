    ...
    <body class="skin-blue" onLoad="adjustWindow()">
		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<form role="form">
        		<?php
				$txt = "<p align='center'><strong>รายงานผู้รับบริการที่ได้รับยาสมุนไพร</strong></p>";
...
function getData(){
			...
			var url = "../genxml/genxml_drug_panthai.php?str="+str;
...
function getXls(){
	var str = document.getElementById('datestart').value;
	var url = "../xls/xls_drug_panthai.php?str="+str;
	window.open(url,'data','top=120,left=250,width=800,height=500');
}
function getchart(){
	var str = document.getElementById('datestart').value;
	var url = "../chart/chart_drug_panthai.php?str="+str;
	window.open(url,'data','top=120,left=250,width=800,height=500');
}
function getsum(){
	var str = document.getElementById('datestart').value;
	var url = "../sum/sum_drug_panthai.php?str="+str;
	window.open(url,'data','top=120,left=250,width=800,height=500');
}
</script>
