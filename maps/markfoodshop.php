...
<form role="form">
        		<?php
				$txt = "<p align='center'><strong>บันทึก/แก้ไข<br> ตำแหน่งร้านขายอาหารสำเร็จรูป</strong></p><br><div class='text text-danger'> กรุณาเลือกหมู่บ้านก่อนบันทึก</div>";
...
var customIcons = {
  ...
  function getData(){
			...
			var url = "../genxml/genxml_markfoodshop.php?villcode="+villcode;
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = "<img src='../img/"+simg+"'> ลำดับที่ " + mno+"<br>"+hname;
...
function delData(hcode){
  createXMLHttpRequest();
      var urld = "../execute/execute_foodshop.php?hcode=" + hcode;	
...
function saveData(){
      ...
      var url = "../execute/execute_foodshop.php?villagecode="+villagecode+"&fsno="+fsno+"&lat="+uplat+"&lng="+uplng; 
	  createXMLHttpRequest();
