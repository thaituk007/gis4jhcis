...
<html>
		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<section class="sidebar">
                	<div id="pleft">
        		<?php
				$txt = "<p align='center'><strong>ทะเบียนผู้ป่วยโรคเรื้อรัง</strong></p>";
	...
	$result=mysql_query($sql,$link);
	while($row=mysql_fetch_array($result)) {
		$txt .= "<option value='$row[groupcode]'>$row[groupname]</option>";
	}
	$txt .= "</select>
                            	</div><!-- /.input group -->
                		</div><!-- /.form group -->";			
...
function getData(){
			...
			var url = "../genxml/genxml_chronic.php?chronic="+chronic+"&village="+village;
...
function getXls(){
		var chronic = document.getElementById('chronic').value;
		var village = document.getElementById('village').value;
		var url = "../xls/xls_chronic.php?chronic="+chronic+"&village="+village;
	window.open(url,'data','top=120,left=250,width=700,height=550');
}
function getchart(){
		var chronic = document.getElementById('chronic').value;
		var village = document.getElementById('village').value;			
		var url = "../chart/chart_chronic.php?chronic="+chronic+"&village="+village;
	window.open(url,'data','top=120,left=250,width=900,height=500');
}
function getsum(){
		var chronic = document.getElementById('chronic').value;
		var village = document.getElementById('village').value;		
		var url = "../sum/sum_chronic.php?chronic="+chronic+"&village="+village;
