		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<section class="sidebar">
                	<div id="pleft">
        		<?php
				$txt = "<p align='center'><strong>รายงานหญิงตั้งครรภ์<br>ที่ได้รับการตรวจฟัน</strong></p>";
...
function getData(){
			...
			var url = "../genxml/genxml_anc_tooth.php?str="+str+"&village="+village;
		  ...
		  var toothcheck = xmldata[i].getAttribute("toothcheck");
		  var chk = xmldata[i].getAttribute("chk");
		  var caries = xmldata[i].getAttribute("caries");
		  var gumfail = xmldata[i].getAttribute("gumfail");
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+" อายุ "+age+" ปี<br><img src='../img/"+simg+"'>บ้านเลขที่ "+hono+" หมู่ " +vill +"<br>ครรภ์ที่"+pregno+" "+anc_chk;
		   	html2 = pname+" อายุ "+age+" ปี<br><img src='../img/"+simg+"'> หมู่ "+moo+ " บ้านเลขที่ "+hono+"<br>ครรภ์ที่ "+pregno+" "+anc_chk+"<br>พบฟันผุ "+caries+" ซึ่  หงือกอักเสบ "+gumfail+" หินน้ำลาย "+tartar;
			var icon;
			if(chk == "1"){
				hno = hno + 1;
			 	icon = customIcons['c0'];
...
function getXls(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;		
		var url = "../xls/xls_anc_tooth.php?str="+str+"&village="+village;
	window.open(url,'data','top=120,left=250,width=700,height=550');
}
function getchart(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;		
		var url = "../chart/chart_anc_tooth.php?str="+str+"&village="+village;
	window.open(url,'data','top=120,left=250,width=900,height=500');
}
function getsum(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;			
		var url = "../sum/sum_anc_tooth.php?str="+str+"&village="+village;
