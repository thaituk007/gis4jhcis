		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<section class="sidebar">
                	<div id="pleft">
        		<?php
				$txt = "<p align='center'><strong>ผู้พิการที่ได้รับการเยี่ยมบ้าน</strong></p>";
				...
				$txt .= "<div class='form-group'>
             				<label>เลือกประเภทอยู่อาศัย</label>
                  				<div class='input-group'>
                                	...
                                	<select name='live_type' id='live_type' class='form-control' onchange='getData();'><option value='1'>ที่อาศัยอยู่จริง (0,1,3)</option><option value='99'>ทั้งหมดในเขตรับผิดชอบ(0,1,2,3)</option><option value='2'>ตามทะเบียนบ้าน(0,1,2)</option></select>
                            	</div><!-- /.input group -->
                		</div><!-- /.form group -->";	
...
function getData(){
			...
			var url = "../genxml/genxml_anc_4_q.php?str="+str+"&village="+village+"&live_type="+live_type;
		  ...
		  var anc1 = xmldata[i].getAttribute("anc1");
		  var anc2 = xmldata[i].getAttribute("anc2");
		  var anc3 = xmldata[i].getAttribute("anc3");
		  var anc4 = xmldata[i].getAttribute("anc4");
		  var anc5 = xmldata[i].getAttribute("anc5");
		  var anc_chk = xmldata[i].getAttribute("anc_chk");
		  var pregno = xmldata[i].getAttribute("pregno");
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+" อายุ "+age+" ปี<br><img src='../img/"+simg+"'>บ้านเลขที่ "+hono+" หมู่ " +vill +"<br>ครรภ์ที่"+pregno+" "+anc_chk;
		   	html2 = pname+" อายุ "+age+" ปี<br><img src='../img/"+simg+"'> หมู่ "+moo+ " บ้านเลขที่ "+hono+"<br>ครรภ์ที่ "+pregno+" ฝากครรภ์ครัั้งที่ 1,2,3,4,5<br>"+anc1+", "+anc2+", "+anc3+", "+anc4+", "+anc5;
			var icon;
			if(chk == "1"){
				hno = hno + 1;
			 	icon = customIcons['c0'];
			...
			var legent = "<img src='../img/c001.png'> = ฝากครรภ์ครบคุณภาพ "+hno+" คน<br> <img src='../img/c003.png'> = ฝากครรภ์ยังไม่ครบคุณภาพ "+rok+" คน<br> <img src='../img/c006.png'> = ไม่มีข้อมูล "+hok+" คน";		
...
function getXls(){
		...
		var str = document.getElementById('datestart').value;
		var live_type = document.getElementById('live_type').value;			
		var url = "../xls/xls_anc_4_q.php?str="+str+"&village="+village+"&live_type="+live_type;
...
function getchart(){
		...
		var str = document.getElementById('datestart').value;
		var live_type = document.getElementById('live_type').value;			
		var url = "../chart/chart_anc_4_q.php?str="+str+"&village="+village+"&live_type="+live_type;
...
function getsum(){
		...
		var str = document.getElementById('datestart').value;
		var live_type = document.getElementById('live_type').value;			
		var url = "../sum/sum_anc_4_q.php?str="+str+"&village="+village+"&live_type="+live_type;
