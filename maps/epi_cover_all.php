		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<section class="sidebar">
                	<div id="pleft">
        		<?php
				$txt = "<p align='center'><strong>รายงานความครอบคลุมวันซีน<br>ของเด็กอายุ 0 - 71 เดือน</strong></p>";
				...
				$txt .= "<div class='form-group'>
             				<label>เลือกกลุ่ม : </label>
                  				<div class='input-group'>
                                	...
                                	<select name='chk_epi' id='chk_epi' class='form-control' onchange='getData();'><option value='9'>แสดงทุกคน</option><option value='1'>เฉพาะเด็กที่รับวัคซีนครบ</option><option value='0'>เฉพาะเด็กที่รับวัคซีนไม่ครบ</option></select>
                            	</div><!-- /.input group -->
                		</div><!-- /.form group -->";
				$txt .= "<div class='form-group'>
...
function getData(){
			...
			var chk_epi = document.getElementById('chk_epi').value;
			var str = document.getElementById('datepicker-th1').value;
			var live_type = document.getElementById('live_type').value;	
			var url = "../genxml/genxml_epi_cover_all.php?str="+str+"&village="+village+"&chk_epi="+chk_epi+"&live_type="+live_type;
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+" อายุ "+age+" เดือน<br><img src='../img/"+simg+"'>บ้านเลขที่ "+hono+" หมู่ " +vill +"<br>ว/ด/ป เกิด "+birth+"<br>"+epi_chk;
		   	html2 = pname+"<br>บ้านเลขที่่ "+hono+ " หมู "+vill+"<br>ว/ด/ป เกิด "+birth+" อายุ "+age+" เดือน<br>"+epi_chk;
			var icon;
			if(chk == 0){
				hno = hno + 1;
			 	icon = customIcons['c1'];	
			...
			var legent = "<img src='../img/c001.png'> = รับวัคซีนตรบตามเกณฑ์ "+hok+" คน<br> <img src='../img/c006.png'> = รับวัคซีนไม่ครบตามเกณฑ์ "+hno+" คน";		
...
function getXls(){
		...
		var str = document.getElementById('datepicker-th1').value;
		var live_type = document.getElementById('live_type').value;		
		var url = "../xls/xls_epi_cover_all.php?str="+str+"&village="+village+"&chk_epi="+chk_epi+"&live_type="+live_type;
...
function getchart(){
		...
		var str = document.getElementById('datepicker-th1').value;	
		var live_type = document.getElementById('live_type').value;
		var url = "../chart/chart_epi_cover_all.php?str="+str+"&village="+village+"&live_type="+live_type;
...
function getsum(){
		...
		var str = document.getElementById('datepicker-th1').value;	
		var live_type = document.getElementById('live_type').value;
		var url = "../sum/sum_epi_cover_all.php?str="+str+"&village="+village+"&live_type="+live_type;
