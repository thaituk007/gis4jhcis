...
function getData(){
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+" อายุ "+age+" ปี<br><img src='../img/"+simg+"'> หมู่ "+moo+ " บ้านเลขที่ "+hono+"<br> ฝากครรภ์ครั้งแรก "+first_visit_date+" ขณะอายุครรภ์ "+agepreg+" สัปดาห์";
		   	html2 = pname+" อายุ "+age+" ปี<br>บ้านเลขที่ "+hono+" หมู่ " +vill +"<br> ฝากครรภ์ครั้งแรก"+first_visit_date+" ขณะอายุครรภ์ "+agepreg+" สัปดาห์";
			var icon;
			if(chk == "1"){
				hno = hno + 1;
			 	icon = customIcons['c0'];
			...
			var legent = "<img src='../img/c001.png'> = ฝากครรภ์ครั้งแรกก่อน 12 week "+hno+" <br> <img src='../img/c003.png'> = ฝากครรภ์ครั้งแรกหลัง 11 week "+rok+"<br> <img src='../img/c006.png'> = ไม่ระบุ "+hok;		
