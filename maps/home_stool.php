		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<section class="sidebar">
                	<div id="pleft">
        		<?php
				$txt = "<p align='center'><strong>รายงานการตรวจพยาธิ2</strong></p>";
...
function getData(){
			...
			var url = "../genxml/genxml_home_stool.php?str="+str+"&village="+village;
		  ...
		  var pa = xmldata[i].getAttribute("pa");
		  var pv = xmldata[i].getAttribute("pv");
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+"<br><img src='../img/"+simg+"'> หมู่ "+moo+ " บ้านเลขที่ " + hono+" (" + pa+"/"+pv+")";
		   	html2 = pname+"<br>บ้านเลขที่ "+hono+" หมู่ " +vill +"<br>เป้าทั้งหมด "+pa+" คน ตรวจ "+
						pv+" คน<br><a href='#' onclick='hom_stool("+hcode+");'>รายละเอียด</a>";
			var icon;
			if(pv == 0){
				hno = hno + 1;
			 	icon = customIcons['c0'];
			...
			var legent = "<img src='../img/c006.png'> = ได้รับการตรวจ "+hok+" หลังคาเรือน <br><img src='../img/c001.png'> = ไม่ได้ตรวจ "+hno+" หลังคาเรือน";		
...
function hom_stool(hcode){
	var str = document.getElementById('datestart').value;			
	var tget = "../xls/xls_home_stool.php?str="+str+"&hcode="+hcode;
