		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<section class="sidebar">
                	<div id="pleft">
        		<?php
				$txt = "<p align='center'><strong>รายงานการเยี่ยมหลังคลอด</strong></p>";
...
function getData(){
			...
			var url = "../genxml/genxml_mch.php?str="+str+"&village="+village;
		  ...
		  var mothername = xmldata[i].getAttribute("mothername");
		  ...
		  var childname = xmldata[i].getAttribute("childname");
		  var chk_m1 = xmldata[i].getAttribute("chk_m1");
		  var chk_m2 = xmldata[i].getAttribute("chk_m2");
		  var chk_m3 = xmldata[i].getAttribute("chk_m3");
		  var m1 = xmldata[i].getAttribute("m1");
		  var m2 = xmldata[i].getAttribute("m2");
		  var m3 = xmldata[i].getAttribute("m3");
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = mothername+" อายุ "+age+" ปี<br><img src='../img/"+simg+"'>บ้านเลขที่ "+hono+" หมู่ " +vill +"<br>ชื่อบุตร "+childname+"<br>เยี่ยม "+m1+", "+m2+", "+m3+"";
		   	html2 = mothername+" อายุ "+age+" ปี<br>หมู่ "+moo+ " บ้านเลขที่ "+hono+"<br>ชื่อบุตร "+childname+"<br>เยี่ยม "+m1+", "+m2+", "+m3+"";
			var icon;
			if(chk_m1 != ""){
				hno = hno + 1;
			 	icon = customIcons['c0'];
			...
			var legent = "<img src='../img/c001.png'> = เยี่ยมครั้งที่ 1 จำนวน "+hno+" คน<br> <img src='../img/c003.png'> = เยี่ยมครั้งที่ 2 จำนวน "+rok+" คน<br> <img src='../img/c006.png'> = เยีย่มครั้งที่ 3 จำนวน "+hnk+" คน";		
...
function getXls(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;	
		var url = "../xls/xls_mch.php?str="+str+"&village="+village;
	window.open(url,'data','top=120,left=250,width=700,height=550');
}
function getchart(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;		
		var url = "../chart/chart_mch.php?str="+str+"&village="+village;
	window.open(url,'data','top=120,left=250,width=950,height=500');
}
function getsum(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;		
		var url = "../sum/sum_mch.php?str="+str+"&village="+village;
