		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<section class="sidebar">
                	<div id="pleft">
        		<?php
				$txt = "<p align='center'><strong>รายงานการประเมินโภชนาการผู้สูงอายุ</strong></p>";
				...
				$txt .= "<div class='form-group'>
             				<label>กลุ่ม</label>
                  				<div class='input-group'>
                                	...
                                	<select name='chk_old' id='chk_old' class='form-control' onchange='getData();'><option value='9'>แสดงทุกคน</option><option value='8'>เฉพาะที่ชั่งน้ำหนัก</option><option value='1'>ผอม</option><option value='2'>ปกติ</option><option value='3'>อ้วน</option><option value='0'>ยังไม่ได้ชั่ง</option></select>
                            	</div><!-- /.input group -->
                		</div><!-- /.form group -->";	
...
function getData(){
			...
			var url = "../genxml/genxml_old_nutri.php?str="+str+"&village="+village+"&chk_old="+chk_old;
		  ...
		  var bmi = xmldata[i].getAttribute("bmi");
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+" อายุ "+age+" ปี<br><img src='../img/"+simg+"'>บ้านเลขที่ "+hono+" หมู่ " +vill +"<br>วันที่ชั่ง "+visitdate+"<br> ผลการชั่ง "+old_chk;
		   	html2 = pname+" อายุ "+age+" ปี<br>หมู่ "+moo+ " บ้านเลขที่ "+hono+"<br>วันที่ชั่ง "+visitdate+"<br>น้ำหนัก "+weight+" kg สูง "+height+" cm BMI "+bmi+" สรุป "+old_chk;
			var icon;
			if(chk == "ผอม"){
				hno = hno + 1;
			 	icon = customIcons['c0'];
			...
			var legent = "<img src='../img/c001.png'> = ผอม "+hno+" คน<br> <img src='../img/c003.png'> = ปกติ "+rok+" คน<br> <img src='../img/c006.png'> = อ้วน "+hnk+" คน<br> <img src='../img/c002.png'> = ยังไม่ได้วัด "+hok+" คน";		
...
function getXls(){
		...
		var chk_old = document.getElementById('chk_old').value;
		var str = document.getElementById('datestart').value;			
		var url = "../xls/xls_old_nutri.php?str="+str+"&village="+village+"&chk_old="+chk_old;
	window.open(url,'data','top=120,left=250,width=700,height=550');
}
function getchart(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;		
		var url = "../chart/chart_old_nutri.php?str="+str+"&village="+village;
	window.open(url,'data','top=120,left=250,width=950,height=500');
}
function getsum(){
		var village = document.getElementById('village').value;
		var str = document.getElementById('datestart').value;		
		var url = "../sum/sum_old_nutri.php?str="+str+"&village="+village;
