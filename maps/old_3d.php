		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<aside class="left-side sidebar-offcanvas">
				...
				<section class="sidebar">
                	<div id="pleft">
        		<?php
				$txt = "<p align='center'><strong>รายงานการประเมินสุขภาพผู้สูงอายุ<br> (ติดสังคม, ติดบ้าน, ติดเตียง)</strong></p>";
				...
				$txt .= "<div class='form-group'>
             				<label>เลือกกลุ่ม : </label>
                               ...
                               <select name='chk_old' id='chk_old' class='form-control' onchange='getData();'><option value='9'>แสดงทุกคน</option><option value='8'>เฉพาะที่ประเมิน</option><option value='1'>ติดสังคม</option><option value='2'>ติดบ้าน</option><option value='3'>ติดเตียง</option><option value='0'>ยังไม่ประเมิน</option></select>
                            	</div><!-- /.input group -->
                		</div><!-- /.form group -->";		
...
function getData(){
			...
			var url = "../genxml/genxml_old_3d.php?village="+village+"&chk_old="+chk_old;
		  ...
		  var latlng = new google.maps.LatLng(lat, lng);
			...
			html = pname+" อายุ "+age+" ปี<br><img src='../img/"+simg+"'>บ้านเลขที่ "+hono+" หมู่ " +vill +"<br>วันที่ปรับปรุง "+visitdate+"<br> ผู้สูงอายุ "+old_chk;
		   	html2 = pname+" อายุ "+age+" ปี<br>หมู่ "+moo+ " บ้านเลขที่ "+hono+"<br>วันที่ปรับปรุง "+visitdate+"<br> ผู้สูงอายุ "+old_chk;
			var icon;
			if(chk == "3"){
				hno = hno + 1;
			 	icon = customIcons['c0'];
			...
			var legent = "<img src='../img/c001.png'> = ติดเตียง "+hno+" คน<br> <img src='../img/c003.png'> = ติดบ้าน "+rok+" คน<br> <img src='../img/c006.png'> = ติดสังคม"+hnk+" คน<br> <img src='../img/c002.png'> = ยังไม่ได้ประเมิน "+hok+" คน";		
...
function getXls(){
		var village = document.getElementById('village').value;
		var chk_old = document.getElementById('chk_old').value;
		var url = "../xls/xls_old_3d.php?village="+village+"&chk_old="+chk_old;
	window.open(url,'data','top=120,left=250,width=700,height=550');
}
function getchart(){
		var village = document.getElementById('village').value;		
		var url = "../chart/chart_old_3d.php?village="+village;
	window.open(url,'data','top=120,left=250,width=950,height=500');
}
function getsum(){
		var village = document.getElementById('village').value;		
		var url = "../sum/sum_old_3d.php?village="+village;
