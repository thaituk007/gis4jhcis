...
v.villno,
v.villcode,
p.pid,pidvola,h.xgis,h.ygis,if(instr(hno,'/')>0,substring(hno,1,instr(hno,'/')-1),hno) as f,h.usernamedoc,0 AS fbs,0 AS sys,0 AS dias,00.00 AS a1c,0 AS ball,'' AS dserv
FROM
house AS h
