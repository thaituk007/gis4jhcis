...
$result = mysql_query($sql);
$txt = '<p align=\'center\'><b>จำนวนผู้พิการที่ได้รับการเยี่ยมบ้าน</b><br>';
$txt .= "<b>ข้อมูลระหว่างวันที่ $_GET[str] ถึง $_GET[sto]  $mu </b></p><br><b>$hosp</b><table width='99%' border='0' cellspacing='1' cellpadding='1' class='table table-striped table-hover table-bordered'>
  <tr>
    ...
    <th width='8%' scope='col'><div align='center'>ผู้พิการทั้งหมด</div></th>
