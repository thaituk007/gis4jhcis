...
$result = mysql_query($sql);
$txt = '<p align=\'center\'><b>จำนวนผู้ได้รับถุงยางอนามัยในงานป้องกันเอดส์';
$txt .= "$mu</b></p><b>$hosp</b><br><table width='99%' border='0' cellspacing='1' cellpadding='1' class='table table-striped table-hover table-bordered'>
  <tr>
	...
	<th width='8%' scope='col'>จำนวนจ่าย(ชิ้น)</th>
...
while($row=mysql_fetch_array($result)) {
	...
	$sum_unitcondom = $sum_unitcondom+$row[unitcondom];
++$x;
...
$txt .="  <tr $cr>
	...
	<td><div align='center'>$row[unitcondom]</td>
    <td></td>
  </tr>
  ";
}
$txt .= "<tr>
  ...
  <td><div align='center'>$sum_unitcondom</div></td>
  <td>&nbsp;&nbsp;</td>
  </tr></table><p div align='right' class='text-danger'>ข้อมูลระหว่างวันที่  $strx ถึง $stox  <br>";  
echo $txt;
?>
<?php
}
