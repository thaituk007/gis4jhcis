...
$result = mysql_query($sql);
$txt = '<p align=\'center\'><b>จำนวนผู้ป่วยด้วยโรคที่ต้องเฝ้าระวังทางระบาดวิทยา<br>';
$txt .= "$mu</p><br>$hosp</b><div class='table-responsive'><table class='table table-striped table-hover table-bordered' width='100%' border='0' cellspacing='1' cellpadding='1'>
  <tr>
    ...
    <th width='12%' scope='col'><div align='center'>โรค 506</div></th>
	<th width='8%' scope='col'><div align='center'>จำนวนครั้ง</div></th>
  </tr>";
