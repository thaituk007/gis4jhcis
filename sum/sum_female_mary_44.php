...
h.villcode,
village.villname,
sum(case when p.sex = '2' then 1 else 0 end) as allper,
...
$result = mysql_query($sql);
$txt = '<p align=\'center\'><b>หญิงอายุ 20 - 44 ปี วางแผนครอบครัว</b><br>';
$txt .= "<b> $mu </b></p><br><b>$hosp</b><table width='95%' border='0' cellspacing='1' cellpadding='1' class='table table-striped table-hover table-bordered'>
  <tr>
	...
	<th width='4%' scope='col'><div align='center'>หญิงอายุ 20-44 ปี</div></th>
    <th width='8%' scope='col'><div align='center'>หญิงอายุ 20-44 ปี อยุ่กินกับสามี</div></th>
...
if($row[per_all] == "0"){
	...
	$sum_allper = $sum_allper+$row[allper];
...
$txt .="  <tr $cr>
	...
	<td><div align='center'>$row[allper]</div></td>
...
$txt .= "<tr>
  ...
  <td>&nbsp;&nbsp;</td>
  <td><div align='center'>$sum_allper</div></td>
