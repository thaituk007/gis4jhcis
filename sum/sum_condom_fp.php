...
ORDER BY house.villcode,v.visitdate) as tmp
...
$result = mysql_query($sql);
$txt = '<p align=\'center\'><b>จำนวนผู้ได้รับถุงยางอนามัยในงานวางแผนครอบครัว<br>ระหว่างวันที่  ';
$txt .= "$mu</b><br></p><br><b>$hosp</b><br><table width='99%' border='0' cellspacing='1' cellpadding='1' class='table table-striped table-hover table-bordered'>
  <tr>
